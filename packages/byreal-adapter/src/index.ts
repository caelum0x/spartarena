...
export { LiveByrealAdapter, analyzePoolInfo, buildTokenDiscovery } from "./live.js";
export type {
  LiveByrealAdapterOptions,
  AnalyzePoolInfoOptions,
  BuildTokenDiscoveryOptions,
} from "./live.js";
export {
  ByrealRestClient,
  ByrealRequestError,
...
export interface CreateByrealAdapterOptions
  extends MockByrealAdapterOptions,
    LiveByrealAdapterOptions {
  /**
...
function mockEnvEnabled(): boolean {
  const raw =
    typeof process !== "undefined" ? process.env?.BYREAL_MOCK : undefined;
  if (!raw) return false;
 ...
 */
export function createByrealAdapter(
  options: CreateByrealAdapterOptions = {},
): ByrealSkillAdapter {
